...
<body id="condition">
	<div id="wrap"  style="height:660px">
		...
		<div class="item item-search">
			<div class="zg-form">
				<div class="inpItem">
					<span class="input-group-addon12">&nbsp;<font style='color:red;'>*</font>产品层次：</span>
					<div class="inpBox zg-inpMany code-goods">
						<input id="brandCode" name="brandCode" type="text" class="zg-form-control" >
  ...
  <section class="result">
	...
	<script src="${request.contextPath}/js/npms/modelProduceLevel.js"></script>
...
function getAuthByPage(pageNumber) {
	...
	$.ajax({
		url : ctx+'/productLevel/productLevelQueryData.action',
		type : "post",
