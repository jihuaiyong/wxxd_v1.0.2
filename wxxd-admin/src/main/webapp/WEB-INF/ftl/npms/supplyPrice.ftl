        ...
        <div class="row">
            <div class="col-md-3">
                <div class="input-group">
                    <span class="input-group-addon"><font color="red">*</font>商品编码：</span>
                    <input id="cmmdtyCode" type="text" class="form-control"
                           onblur="checkCmmdtyCodeUtil('cmmdtyCode')">
                </div>
            </div>
            <div class="col-md-3">
                <div class="input-group">
                    ...
                    <input id="supplier" type="text" class="form-control"
                           onblur="checkSupplierCodeUtil('supplier')">
                </div>
            </div>
            <div class="col-md-3">
                <div class="input-group">
                ...
                <div class="input-group">
                    <div style="float: left;margin-left: 20px">
                        <font style='color:red;'>
                                <span id="tips" class="tipTxt"></span>
                        </font>
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="margin-top:10px;">
            ...
            <div class="col-md-3">
                <div class="input-group">
                    ...
                    <input type="text"
                           class=" form-control WdateBackPic"
            ...
            <div class="col-md-3">
                <div class="input-group">
                    ...
                    <input id="orderType" type="text" class="form-control">
                </div>
            </div>
            <div class="col-md-3">
                <div class="input-group">
        ...
        <div class="row" style="margin-top:10px;">
            <div class="col-md-3">
                <div class="input-group">
                    <span class="input-group-addon">&nbsp;&nbsp;&nbsp;&nbsp;
                        经代销：</span>
                    <select type="text" class="form-control" id="distSell" >
...
<script src="${request.contextPath}/js/npms/supplyPrice.js" type="text/javascript"></script>
