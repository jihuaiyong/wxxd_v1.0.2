...
<div id="wrap" style="height: 660px">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="input-group">
                    <span class="input-group-addon">发货地点：</span>
                    <input id="plantCode"  name="plantCode" type="text" class="form-control" style="width:120px;margin-right:10px;">

                </div>
            </div>
            <div class="col-md-3">
                <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1">发货城市：</span>
                    <input id="cityFrom"  name="cityFrom" type="text" class="form-control" style="width:120px;margin-right:10px;">
                </div>
            </div>

            <div class="col-md-3">
                <div class="input-group">
                    <span class="input-group-addon">辐射模式：</span>
                    <input id="raditionModel"  name="raditionModel" type="text"  class="form-control"  style="width:120px;margin-right:10px;">
                </div>
            </div>
            <div class="col-md-3">
                <div class="input-group">
    ...
    <section class="result">
        ...
        <form id="fileUploadForm" name="fileUploadForm" enctype="multipart/form-data" action="${request.contextPath}/PlantConfig/fileUpload.action" method="post">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="titleinit">新增发货地点配置</h4>
            </div>
            <div class="modal-body">
                ...
                <div style="margin: 20px 0;" class="zg-group">
                    ...
                    <div style="display:inline-block;margin-left: 15px;" class="inpBox">
                        <input  type="text" class="form-control" name="plant_code" ime-mode:disabled"  id="plant_code" onchange="restSpan()">
                    </div>
                    <font style='color:red;'><span id="plantCodeSpan" class="tipTxt"></span></nobr></font>
                </div>

                <div style="margin: 20px 0;" class="zg-group">
                    <label>发货城市：</label>
                    <div style="display:inline-block;margin-left: 15px;" class="inpBox">
                        <input  type="text" class="form-control" name="city_from" ime-mode:disabled"  id="city_from" onchange="restSpan()">
                    </div>
                    <font style='color:red;'><span id="cityFromSpan" class="tipTxt"></span></nobr></font>
                </div>

                <div style="margin: 20px 0;" class="zg-group">
                    <label>辐射模式：</label>
                    <div style="display:inline-block;margin-left: 15px;" class="inpBox">
                        <input  type="text" class="form-control" name="radition_model" ime-mode:disabled"  id="radition_model" onchange="restSpan()">
                    </div>
                    <font style='color:red;'><span id="raditionModelSpan" class="tipTxt"></span></nobr></font>
                </div>
...
<script src="${request.contextPath}/js/npms/plantConfig.js"></script>
