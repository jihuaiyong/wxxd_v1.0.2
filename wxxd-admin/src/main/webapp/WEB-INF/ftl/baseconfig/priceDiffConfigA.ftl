...
<head>
    ...
    <link rel="stylesheet" href="${request.contextPath}/libs/bootstrap3-select/bootstrap-select.css">
...
<div id="wrap" style="height: 660px">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="input-group">
                    <span class="input-group-addon">产品层次：</span>
                    <input id="brandCode" type="text"  class="form-control" style="width:170px;margin-right:10px;">
                </div>
            </div>
            <div class="col-md-3">
                <div class="input-group" style="margin-left: 40px">
                    <span class="input-group-addon" style="border-right: 0">商品类目：</span>
                    <input id="categCode" type="text"  class="form-control" style="width:170px;margin-right:10px;">
                </div>
            </div>
            <div class="col-md-3">
    ...
    <section class="result">
        ...
        <form id="fileUploadForm" name="fileUploadForm" enctype="multipart/form-data" action="${request.contextPath}/PriceDiffConfigA/fileUpload.action" method="post">
            ...
            <div class="modal-body">
                ...
                <div style="margin: 20px 0;" class="zg-group">
                    ...
                    <div style="display:inline-block;margin-left: 15px;" class="inpBox">
                        <input  type="text" class="form-control" name="brand_code" ime-mode:disabled"  id="brand_code" onchange="restSpan()">
                    </div>
                    <font style='color:red;'><span id="brandCodeSpan" class="tipTxt"></span></nobr></font>
                </div>

                <div style="margin: 20px 0;" class="zg-group">
                    <label>商品类目：</label>
                    <div style="display:inline-block;margin-left: 15px;" class="inpBox">
                        <input  type="text" class="form-control" name="categ_code" ime-mode:disabled"  id="categ_code" onchange="restSpan()">
                    </div>
                    <font style='color:red;'><span id="categCodeSpan" class="tipTxt"></span></nobr></font>
                </div>
...
<script src="${request.contextPath}/js/npms/priceDiffConfigA.js"></script>
