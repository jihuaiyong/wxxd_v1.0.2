...
<div id="wrap" style="height: 660px">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="input-group">
                    ...
                    <input id="brandCode" type="text"  class="form-control" style="width:180px;margin-right:10px;">
                </div>
            </div>
            <div class="col-md-3">
                <div class="input-group">
    ...
    <section class="result">
        ...
        <div class="info clearfix">
            ...
            <form id="fileUploadForm" name="fileUploadForm" enctype="multipart/form-data" action="${request.contextPath}/PriceDiffConfigB/fileUpload.action" method="post">
                ...
                <div class="wenjiuan-area" style="padding: 0px;">
                    <i><a href="##" onclick = javascript:downloadModel();>上传模板下载</a>
                    </i>
                </div>
                <#if result ??>
		            <div id="result" name="result" style="margin-bottom:50px;">导入的记录：<font style="color:red">${result!''}<br/></font></div>
                </#if>
            </form>
    </section>
</div>
...
<script src="${request.contextPath}/js/npms/priceDiffConfigB.js"></script>
