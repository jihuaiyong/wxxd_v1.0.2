			...
			$.ajax({
				...
				success : function(msg) {
					...
					try {
						...
						if(!commonUtil.isEmpty(ssoJson) && ssoJson.idsIntercepted && ssoJson.status == 'UNKNOWN'){
					...
					$("#"+parentid).empty().html(msg);
					if(callBack && (callBack instanceof Function)){
			            callBack();//回调
			        };
				},
				error : function(XMLHttpRequest, textStatus, errorThrown) {
					$("#"+parentid).empty().append("服务器内部错误，请联系管理员！");
				}
			});
			return false;
        },
