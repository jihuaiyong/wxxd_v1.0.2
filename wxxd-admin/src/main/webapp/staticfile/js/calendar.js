        ...
        ECode.calendar = function(options){
            ...
            var calendarfn = {
                ...
                createContainer:function(){//创建日历最外层div
                    ...
                    container.css({"position":"absolute","zIndex":999,"left":inputPos.left-126,"top":inputPos.top+input.outerHeight()+3});
                ...
                linkOn:function(){//每个日期点击事件
                    ...
                    links.each(function(a){
                        $(this).click(function(){
                            ...
                            var weeks = oDate.getDay();//此处是显示星期.Update by zhoudexin 2012.10.01 pm 4:01
							if(weeks == 1){
								weeks= "星期一";
							} else if(weeks == 2){
								weeks = "星期二";
                            ...
                            if(showbox==null){
                                input[0].tagName.toUpperCase()==="INPUT"?input.val($(this)[0]["data-date"]+"  "+weeks):input.text($(this)[0]["data-date"]+"  "+weeks);
                            }else{
                                $(showbox)[0].tagName.toUpperCase()==="INPUT"?$(showbox).val($(this)[0]["data-date"]+"  "+weeks):$(showbox).text($(this)[0]["data-date"]+"  "+weeks);
                            }
